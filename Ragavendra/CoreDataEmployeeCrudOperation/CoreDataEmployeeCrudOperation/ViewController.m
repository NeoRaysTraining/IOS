...
-(UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    cell.salarylLabel.text=[NSString stringWithFormat:@"%@",salarystr];
    cell.placeLabel.text=[Emp valueForKey:@"place"];
    return cell;
}


- (IBAction)AddButton:(id)sender {UIAlertController* controller=[UIAlertController alertControllerWithTitle:@"Add Employee Details " message:@"" preferredStyle:UIAlertControllerStyleAlert];
...
- (IBAction)EditButton:(UIButton *)sender {
   ...
   // NSManagedObject* Emp = self.empDetailsObject[self.path.row];
    ...
    NSManagedObject *Emp=[self.empDetailsObject objectAtIndex:self.path.row];
    ...
    [controller addTextFieldWithConfigurationHandler:^(UITextField * _Nonnull textField) {
        ...
        textField.text=[NSString stringWithFormat:@"%@",[self.empDetailsObject valueForKey:@"age"]];
    ...
    [controller addTextFieldWithConfigurationHandler:^(UITextField * _Nonnull textField) {
        ...
        textField.text=[NSString stringWithFormat:@"%@",[self.empDetailsObject valueForKey:@"salary"]];
...
- (IBAction)swipeLeft:(UIGestureRecognizer *)sender {
    ...
    TableViewCell* cell = [self.tabelView cellForRowAtIndexPath:self.path];
