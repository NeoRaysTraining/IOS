...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
   ...
   // cell.imageView.layer.borderColor = [UIColor blueColor].CGColor;
    ...
    cell.notesLabel.text = [NSString stringWithFormat:@"  %@",[allTitles valueForKey:@"notes"] ];
    
    [cell.buttonImage setBackgroundImage:[UIImage imageNamed:[allTitles valueForKey:@"picture"]] forState:UIControlStateNormal];
...
- (IBAction)addButton:(id)sender{
    ...
    [self addMethod:nil :nil :nil : @"Add Details" : 1 : 0000 : nil];
}
...
- (IBAction)editButton:(UIButton *)sender {
    ...
    [controller addTextFieldWithConfigurationHandler:^(UITextField * _Nonnull textField) {
        textField.text=[employeeObject valueForKeyPath:@"notes"];
    ...
    UIAlertAction* alertaction = [UIAlertAction actionWithTitle:@"Ok" style:UIAlertActionStyleDefault handler:^(UIAlertAction * _Nonnull action) {
        ...
        UITextField* password = [controller.textFields objectAtIndex:2];
         UITextField* notes = [controller.textFields objectAtIndex:3];
        
       
        
        if ([self validateTextfields:title :userName :password : 0 : (int)indexPath.row : notes]) {
        ...
        [employeeObject setValue:notes.text forKey:@"notes"];
        NSError* error=nil;
...
-(BOOL)validateTextfields:(UITextField *)title  : (UITextField *)userName : (UITextField*)password : (int)decideEditOrAdd : (int)decideIndex : (UITextField *)notes{
    ...
    if (([[title.text stringByTrimmingCharactersInSet:[NSCharacterSet whitespaceCharacterSet]]isEqualToString:@""])||([title.text isEqualToString:@""])) {
        ...
        [self showAlert:@"Please Enter Title"  :title :userName :password : decideEditOrAdd : decideIndex : notes];
       ...
       [self showAlert:@"Please Enter User Name" :title :userName :password : decideEditOrAdd : decideIndex : notes];
       ...
       [self showAlert:@"Please Enter Password" :title :userName :password : decideEditOrAdd : decideIndex : notes];
...
-(void)showAlert : (NSString *)myMessage : (UITextField*)title : (UITextField*)userName : (UITextField*)passoword : (int)decideEditOrAdd : (int)decideIndex : (UITextField*)notes{
    ...
    UIAlertAction* defaultAction = [UIAlertAction actionWithTitle:@"OK" style:UIAlertActionStyleDefault
                                                          handler:^(UIAlertAction * action) {
                                                              ...
                                                              [self addMethod:title.text :userName.text :passoword.text : @"Re-Enter Details" : decideEditOrAdd : decideIndex : notes.text];
                                                          }];
...
-(void)addMethod : (NSString*)title : (NSString*)userName : (NSString*)password : (NSString *)alertTitle : (int)decideEditOrAdd : (int)indexPath : (NSString*)notes{
    ...
    UIAlertAction* alertaction = [UIAlertAction actionWithTitle:@"Ok" style:UIAlertActionStyleDefault handler:^(UIAlertAction * _Nonnull action) {
        ...
        if ([self validateTextfields:title :userName :password : decideEditOrAdd : indexPath : notes]) {
            ...
            [self fetchData];
                ...
                [self editMethod:title.text :userName.text :password.text :indexPath : notes.text];
...
-(void)editMethod : (NSString *)title : (NSString *)userName : (NSString *)password : (int)objectIndex : (NSString*)notes{
    ...
    [employeeObject setValue:notes forKey:@"notes"];
    NSError* error=nil;
...
-(void)openApplication : (int)titleIndex{
    ...
    sendUrl = customURL;
    sendEmail = [employeeObject valueForKey:@"userName"];
   sendPassword  = [employeeObject valueForKey:@"password"];
    ...
    else
    {
        ...
        UIAlertController* alert = [UIAlertController alertControllerWithTitle:@"URL Error"
                                                                       message:@"No Application Found \n Are you want to open in All Passwors App?"
                                                                preferredStyle:UIAlertControllerStyleAlert];
        
        UIAlertAction* defaultAction = [UIAlertAction actionWithTitle:@"Open In All Passwords" style:UIAlertActionStyleDefault
                                                              handler:^(UIAlertAction * action) {
...
-(void)prepareForSegue:(UIStoryboardSegue *)segue sender:(id)sender{
    ...
    if ([[segue identifier] isEqualToString:@"image"])
    {
        ...
        [vc getUrl:sendUrl :sendEmail :sendPassword];
