...
int main (int argc, const char * argv[])
{
   NSAutoreleasePool * pool = [[NSAutoreleasePool alloc] init];
	...
	//Checking whether a is having higher val than b and c
    if(a>b && a>c)
    {
    NSLog(@"a is greather than b and c");
    }
    //Checking whether b is having higher val than a and c
    else if(b>a && b>c)
     {
    NSLog(@"b is greather than a and c");
    }
    
	//Checking whether c is having higher val than b and a
    else if(c>a && c>b)
     {
